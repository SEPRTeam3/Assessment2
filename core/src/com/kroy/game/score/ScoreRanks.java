...
//        this.IDsList = new ArrayList<String>[lineNumber++];
...
//            String name = this.IDsList.get(i);
//            csvWriter.append(name);
//            csvWriter.append(",");
//            csvWriter.append(this.scoreMap.get(name));
//            csvWriter.append("/n");
//        }
//        csvWriter.flush();
//        csvWriter.close();
...
//            for (int i = 0; i < 10; i++){
//                outputIDs.add(i, this.IDsList.get(i));
//            } return outputIDs;
...
//            outputIDs.add(this.IDsList(rank-1));
//            outputIDs.add(this.IDsList(rank));
//            return outputIDs;
//        }
//    }
